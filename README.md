...
I've been working tirelessly to try to get as many browsers as I can. I understand that people come from all walks of life, and might not be using chrome, firefox, or opera. I have several desktop browsers I will be testing very soon. These browsers are SRW Iron, Dooble, Côc Côc (Vietnamese browser), Comodo Dragon, Comodo Ice Dragon, Slimjet, Icecat, 360 secure, Torch, Epic Privacy Browser, Avast Secure Browser, Blisk browser, Colibri.
